...
class OpenAPSSMBPlugin @Inject constructor(
    ...
    override fun invoke(initiator: String, tempBasalFallback: Boolean) {
        ...
        if (!hardLimits.checkHardLimits(profile.getIsfMgdl(glucoseStatus.glucose, aggressivity), R.string.profile_sensitivity_value, HardLimits.MIN_ISF, HardLimits.MAX_ISF)) return
